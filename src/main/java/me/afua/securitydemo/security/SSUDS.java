...
public class SSUDS implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        if(loggingIn==null)
         throw new LockedException("Incorrect username or password");

//        UsernameNotFoundException is deprecated because AbstractException is deprecated
        if(loggingIn.isSuspended())
            throw new LockedException("Your account has been suspended. Contact the administrator");
